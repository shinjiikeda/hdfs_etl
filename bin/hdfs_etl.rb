...
kafka_topic_name = "hdfs_etl_queue"
hdfs_prefix = "./test_etl"

kafka_client_id="hdfs_etl_consumer"
kafka_topic_part_num = 64
...
Process.daemon if is_daemon

etl = KafkaETL::Hdfs.new(zookeeper, kafka_brokers, kafka_topic_name, hdfs_prefix,
